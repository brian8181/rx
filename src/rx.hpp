...
const string FMT_FG__LIGHT_GREEN = "\033[92m";
const string FMT_FG__LIGHT_YELLOW = "\033[93m";
const string FMT_FG__LIGHT_BLUE = "\033[94m";
const string FMT_FG__LIGHT_MAGENTA = "\033[95m";
const string FMT_FG__LIGHT_CYAN = "\033[96m";
